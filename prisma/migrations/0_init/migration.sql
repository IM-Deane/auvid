...
-- CreateIndex
CREATE UNIQUE INDEX "pgsodium_key_unique_name" ON "pgsodium"."key"("name");

-- CreateIndex
CREATE UNIQUE INDEX "key_key_id_key_context_key_type_idx" ON "pgsodium"."key"("key_id", "key_context", "key_type");
...
-- AddForeignKey
ALTER TABLE "pgsodium"."key" ADD CONSTRAINT "key_parent_key_fkey" FOREIGN KEY ("parent_key") REFERENCES "pgsodium"."key"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "storage"."objects" ADD CONSTRAINT "objects_owner_fkey" FOREIGN KEY ("owner") REFERENCES "auth"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
